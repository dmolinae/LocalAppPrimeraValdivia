...
namespace PrimeraValdivia.Models
{
    class AfectadoRescate : ViewModelBase
    {
        ...
        public AfectadoRescate(int idRescate, String nombre, String rut, String tipoAfectado, String estado, int fk_idEventoRescate, String prioridad)
		{
		...
		{
			query = String.Format(
				"INSERT INTO AfectadoRescate(idRescate,nombre,rut,tipoAfectado,estado,fk_idEventoRescate,prioridad) VALUES({0},'{1}','{2}','{3}','{4}',{5},'{6}')",
		...
		{
			query = String.Format(
				"UPDATE AfectadoRescate SET idRescate = {0}, nombre = '{1}', rut = '{2}', tipoAfectado = '{3}', estado = '{4}', fk_idEventoRescate = {5}, prioridad = '{6}' WHERE idRescate = {7}",
				AfectadoRescate.idRescate,
				AfectadoRescate.nombre,
				AfectadoRescate.rut,
				AfectadoRescate.tipoAfectado,
